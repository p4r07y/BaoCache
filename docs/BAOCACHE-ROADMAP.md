...
**Tổng mốc beta đã triển khai: 42, gồm beta83 Optimization Advisor foundation.**

### Release control — beta83
...
- **Current state:** beta83 is a functional beta release. Browser compatibility
...
| **beta83 — Optimization Advisor (delivered foundation)** | Risk-ranked recommendations with mechanism, evidence, scope and routing to the owning module's existing preview/apply/rollback. | Deterministic rules only; no direct mutation or AI bypass. |
